...
It integrates Identity login and session tokens, a tenant-aware authorized application launcher, published-menu navigation, safe menu-to-page mapping, runtime service configuration, and Swagger-to-TypeScript contract generation.
