...
export PLATFORM_ENV PLATFORM_IDENTITY_URL PLATFORM_TENANT_URL PLATFORM_AUTHORIZATION_URL PLATFORM_APPLICATION_URL PLATFORM_AUDIT_URL
envsubst '${PLATFORM_ENV} ${PLATFORM_IDENTITY_URL} ${PLATFORM_TENANT_URL} ${PLATFORM_AUTHORIZATION_URL} ${PLATFORM_APPLICATION_URL} ${PLATFORM_AUDIT_URL}' \
